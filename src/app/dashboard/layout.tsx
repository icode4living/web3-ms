      ...
      <div className="flex flex-wrap justify-between items-center">
          ...
          <form action="#" method="GET" className="hidden md:block md:pl-2">
            ...
            <div className="relative  md:w-96">
              ...
              <input
                ...
                name="email"
                id="topbar-search"
                className=" text-sm rounded-lg  block w-full pl-10 p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500"
                placeholder="Search"
              />
            </div>
          </form>
        ...
        <div className="flex items-center lg:order-2">
          ...
          <button
            ...
            className="p-2 mr-1 rounded-lg text-gray-400 hover:text-white hover:bg-gray-700 focus:ring-4  focus:ring-gray-600"
          >
          ...
          {/* Dropdown menu */}
          <div
            className="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none  rounded divide-y  shadow-lg divide-gray-600 bg-gray-700 rounded-xl"
            id="notification-dropdown"
          >
            <div
              className="block py-2 px-4 text-base font-medium text-center  bg-gray-600 text-gray-300"
            >
              Notifications
            </div>
            <div>
              <a
                href="#"
                className="flex py-3 px-4 border-b hover:bg-gray-600 border-gray-600"
              >
                ...
                <div className="pl-3 w-full">
                  <div
                    className=" font-normal text-sm mb-1.5 text-gray-400"
                  >
                    New message from
              ...
              >
                <div className="flex-shrink-0">
                  ...
                  />
                  <div
                    className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-red-600 rounded-full border border-gray-700"
                  >
                    <svg
                      aria-hidden="true"
                      className="w-3 h-3 text-white"
              ...
              >
                <div className="flex-shrink-0">
                  ...
                  />
                  <div
                    className="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-green-400 rounded-full border border-gray-700"
                  >
                    <svg
                      aria-hidden="true"
                      className="w-3 h-3 text-white"
              ...
              <a
                href="#"
                className="flex py-3 px-4 hover:bg-gray-600"
              >
                <div className="flex-shrink-0">
                  <img
                    className="w-11 h-11 rounded-full"
            ...
            <a
              href="#"
              className="block py-2 text-md font-medium text-center  bg-gray-600 text-white hover:underline"
            >
          ...
          <button
            ...
            className="p-2  rounded-lg  text-gray-400 hover:text-white hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
          >
            <span className="sr-only">View notifications</span>
            {/* Icon */}
            <svg
